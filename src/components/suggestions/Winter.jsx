  ...
  return (
    <div className="space-y-12 pb-20">
      <div className="relative">
        ...
        <h1 className="text-7xl font-black italic uppercase tracking-tighter mt-2 text-white">Winter <span className="text-white/10 italic">Protocol</span></h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {cards.map((card, index) => (
          <motion.div 
            ...
            className="group bg-[#0d0d0d] border border-white/5 rounded-3xl overflow-hidden hover:border-blue-500/50 transition-all duration-500 shadow-2xl"
          >
            {/* Image Section */}
